...
//
//        private var timetableNetworkService: TimetableNetworkProtocol
...
//                    self.getTeacherLessons(teacherId: teacher.id, date: DateFormatter().date(from: self.currentDate) ?? Date())
//                }
//            }
//        }
//    }
...
//        Task {
//            try timetableNetworkService.getGroupTimetable(groupId: groupId, date: Date())
//                .receive(on: RunLoop.main)
//                .sink(
//                    receiveCompletion: { _ in },
//                    receiveValue: { [weak self] value in
...
//    }
//
//    private func getTeacherLessons(teacherId: Int, date: Date) {
//        Task {
//            try timetableNetworkService.getTeacherTimetable(teacherId: teacherId, date: date)
//                .receive(on: RunLoop.main)
//                .sink(
//                    receiveCompletion: { _ in },
//                    receiveValue: { [weak self] value in
